      ...
      <div className="w-full max-w-2xl">
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center pb-6">
            ...
            <p className="text-gray-600">Join thousands of students on their career journey</p>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label className="text-sm font-medium text-gray-700">Academic Interest *</Label>
                  <Select
                    value={formData.academicInterest}
                    onValueChange={(value) => handleInputChange("academicInterest", value)}
                  >
                    <SelectTrigger className="bg-white border-gray-200 focus:border-blue-500 focus:ring-blue-500">
